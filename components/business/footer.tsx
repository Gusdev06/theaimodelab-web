...
function Wordmark({ className }: { className?: string }) {
  return (
    <span
      className={cn(
        "font-sora font-bold tracking-tight text-landing-text",
        className,
      )}
    >
      The AI Model <span className="text-landing-accent">Lab</span>
    </span>
  );
}
        ...
        <div className="grid grid-cols-1 gap-8 sm:gap-10 md:grid-cols-12 md:gap-8">
          <div className="md:col-span-5">
            ...
            <p className="mt-5 max-w-[300px] text-[14px] leading-relaxed text-landing-text-muted">
              A complete AI creative studio. Generate images, videos, voices and
              avatars — all in one platform.
            </p>
          ...
          <div className="md:col-span-3 md:col-start-8">
            <h4 className="text-[13px] font-semibold text-landing-text">Product</h4>
          ...
          <div className="md:col-span-2">
            <h4 className="text-[13px] font-semibold text-landing-text">Legal</h4>
            <ul className="mt-4 space-y-3">
              {LEGAL.map((l) => (
                <li key={l.label}>
                  <a
