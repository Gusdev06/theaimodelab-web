...
const STATS = [
  { value: 1500, label: "Influencers created", prefix: "+" },
  ...
  return (
    <section className="relative border-y border-[#f3f0ed]/[0.04] bg-landing-bg-secondary py-10 sm:py-12">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="landing-reveal grid grid-cols-3 gap-5 sm:gap-10 md:flex md:items-center md:justify-center md:gap-16 lg:gap-20">
          {STATS.map((s) => (
            <Stat
              key={s.label}
              value={s.value}
