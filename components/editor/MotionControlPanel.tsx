    ...
    <TooltipProvider>
      ...
      >
        ...
        <div className="panel-drag-handle flex cursor-grab items-center justify-between border-b border-[#f3f0ed]/[0.07] px-4 py-3 active:cursor-grabbing">
          <div className="flex items-center gap-2">
            <AudioWaveform className="h-4 w-4 text-[#e11d2a]" />
          ...
          {genState === 'idle' && (
            <>
              ...
              <div>
                ...
                {videoFile ? (
                  <div className="flex items-center gap-2 rounded-xl border border-[#f3f0ed]/[0.08] bg-[#3a0f16]/15 px-3 py-2.5">
              ...
              <div className="space-y-1.5">
                ...
                <Select value={resolution} onValueChange={setResolution}>
                  ...
                  <SelectContent className="rounded-xl border border-[#f3f0ed]/8 bg-[#111113] p-1 shadow-2xl shadow-black/60 backdrop-blur-md">
                    <SelectItem value="720p" className="cursor-pointer rounded-lg px-3 py-2 text-xs text-[#f3f0ed]/70 transition-all focus:bg-[#3a0f16]/40 focus:text-[#f3f0ed] data-[state=checked]:text-[#e11d2a] [&>span:last-child>svg]:text-[#e11d2a]">720p</SelectItem>
                    <SelectItem value="1080p" className="cursor-pointer rounded-lg px-3 py-2 text-xs text-[#f3f0ed]/70 transition-all focus:bg-[#3a0f16]/40 focus:text-[#f3f0ed] data-[state=checked]:text-[#e11d2a] [&>span:last-child>svg]:text-[#e11d2a]">1080p</SelectItem>
                  </SelectContent>
                </Select>
              </div>
...
function MotionStudioSlot({
  ...
  if (filled) {
    return (
      <div className="group/slot relative aspect-square min-w-0 flex-1 overflow-hidden rounded-xl bg-[#050506]">
        {imagePreview ? (
          /* eslint-disable-next-line @next/next/no-img-element */
          <img src={imagePreview} alt={label} className="h-full w-full object-cover" />
        ) : (
          <div className="flex h-full w-full flex-col items-center justify-center gap-1 px-2 text-[#e11d2a]/80">
