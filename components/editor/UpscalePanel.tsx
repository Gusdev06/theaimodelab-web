            ...
            {genState === 'idle' && !generatedImageUrl ? (
              sourceImage ? (
                ...
                <button
                  ...
                  disabled={isGenerating}
                  className="flex aspect-square w-full flex-col items-center justify-center gap-1.5 rounded-xl bg-[#0d1011] text-[#f3f0ed]/40 transition-all hover:bg-[#0f1416] hover:text-[#f5409d] disabled:cursor-not-allowed disabled:opacity-40"
                >
      ...
      >
        <div className="panel-drag-handle flex cursor-grab items-center justify-between border-b border-[#f3f0ed]/[0.07] px-4 py-3 active:cursor-grabbing">
          <div className="flex items-center gap-2">
            <ImageUpscale className="h-4 w-4 text-[#f5409d]" />
          ...
          {genState === 'idle' && (
            <>
              ...
              <button
                ...
                style={{ background: '#f5409d', color: '#1a2123' }}
              >
