  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 hidden sm:block transition-transform hover:scale-110">
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/40 hover:bg-[#ec4899] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-[#1a2123]"
      >
