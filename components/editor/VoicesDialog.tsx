          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="group flex min-h-[150px] flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-[#e11d2a]/30 bg-[#e11d2a]/5 p-4 text-[#e11d2a]/80 transition-all hover:border-[#e11d2a]/60 hover:bg-[#e11d2a]/10 hover:text-[#e11d2a]"
              >
              ...
              {voices.map((voice) => {
                ...
                return (
                  <div key={voice.id} className="group relative">
                    ...
                    />
                    {isConfirming ? (
                      <div className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-red-400/30 bg-[#111113]/95 p-3 backdrop-blur-sm">
                      ...
                      <button
                        ...
                        className="absolute right-9 top-2 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-[#3a0f16]/40 text-red-400/70 transition-all hover:bg-red-500/20 hover:text-red-400 sm:opacity-0 group-hover:opacity-100"
                        title={t('delete')}
                      >
                        <Trash2 className="h-3 w-3" />
                      </button>
