...
```tsx
const API_BASE = "https://clip-generator-theaimodelab-api.ernvcw.easypanel.host/api/v1";
...
```env
# .env.local
NEXT_PUBLIC_API_URL=https://clip-generator-theaimodelab-api.ernvcw.easypanel.host/api/v1
