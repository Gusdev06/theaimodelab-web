          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <button
              onClick={() => {
                ...
                if (planParam) {
                  document.cookie = `theaimodelab-plan-redirect=${planParam};path=/;max-age=600;samesite=lax`;
                }
                const ref = refParam || document.cookie.match(/(?:^|; )theaimodelab-ref=([^;]*)/)?.[1];
                if (ref) {
                  document.cookie = `theaimodelab-ref=${ref};path=/;max-age=2592000;samesite=lax`;
                }
